...
-- solution 2
select * from EMPLOYEES
where JOB_ID IN('IT PROG','MK_MAN');
...
--display all country names exept country_id is US and IT
select COUNTRY_NAME from COUNTRIES
where COUNTRY_ID NOT IN('US','IT');

--IS NULL
--dispaly all information from employees where department id is null
select * from EMPLOYEES
